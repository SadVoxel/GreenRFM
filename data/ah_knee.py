...
class AHKneeDataset(MRDataset):
    def __init__(self, **kwargs):
        super().__init__(anatomy="knee", **kwargs)
        ...
        try:
            ...
            if len(dataset) > 0:
                ...
                for batch in loader:
                    ...
                    # Check typical keys from MRDataset (may vary, but img_sag/img_cor/img_tra are common)
            ...
            print(f"Error during Knee dataset test: {e}")
            import traceback
            traceback.print_exc()
    else:
